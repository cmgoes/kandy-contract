...
contract sKANDY is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sKANDY", "SKANDY", 9) ERC20Permit() {
    ...
    /**
        @notice increases sKANDY supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sKANDY
